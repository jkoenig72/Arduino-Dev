...
#define mqtt_server "192.168.10.22"
...
#define Gateway_Name "OpenMQTTGateway1"
...
// Update these with values suitable for your network.
  ...
  #define wifi_ssid "jkzone"
  #define wifi_password "123Joerg123"
